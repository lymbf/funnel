                ...
                <div className="mx-auto max-w-3xl px-6 py-10">
                    <article className="space-y-8 text-gray-800">
                        <p>
                            ...
                            <span className="px-1 italic">hierfenster.de</span> ausfüllen. Das Formular dient
                            ausschließlich dazu,
                        ...
                        <section>
                            ...
                            <div className="mt-3 rounded-2xl border bg-white p-6 shadow-sm">
                                ...
                                <ul className="mt-3 list-disc space-y-1 pl-6">
                                    ...
                                    <li>
                                        Telefon: <span className="px-1 font-medium">015679653114</span>
                                    </li>
                                </ul>
                            </div>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="mt-3 grid grid-cols-1 gap-2 sm:grid-cols-2 pl-5 list-disc">
                                ...
                                <li>Telefonnummer</li>
                                <li>Postleitzahl</li>
                                <li>Inhalt der Anfrage sowie Antworten auf Fragen zum Fenstereinbau (falls zutreffend)
                                </li>
                            </ul>
                        ...
                        <section>
                            ...
                            <p className="mt-2">
                                ...
                                vertrauenswürdige Auftragsverarbeiter <span
                                className="font-medium">in unserem Auftrag</span> (auf Grundlage von
                        ...
                        <section>
                            <h2 className="text-xl font-semibold text-gray-900">5. Übermittlung in Drittländer außerhalb
                                des EWR</h2>
                            <p className="mt-2">
                        ...
                        <section>
                            ...
                            <p className="mt-2">Nach Ablauf dieser Fristen werden die Daten gelöscht oder
                                anonymisiert.</p>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="mt-3 list-disc space-y-1 pl-6">
                                ...
                                <li>Widerspruch gegen die Verarbeitung auf Grundlage unseres berechtigten Interesses,
                                </li>
                                <li>
                        ...
                        <section>
                            <h2 className="text-xl font-semibold text-gray-900">8. Automatisierte Entscheidungen und
                                Profiling</h2>
                            <p className="mt-2">Wir treffen keine automatisierten Entscheidungen und führen kein
                                Profiling durch.</p>
                        </section>
                        ...
                        <section>
                            <h2 className="text-xl font-semibold text-gray-900">10. Cookies und Server‑Logs
                                (optional)</h2>
                            <p className="mt-2">
                        ...
                        <section className="rounded-2xl border bg-white p-6 shadow-sm">
                            <h3 className="text-lg font-semibold text-gray-900">Anlage: Informationspflicht direkt beim
                                Formular</h3>
                            <div className="mt-3 space-y-2 text-gray-700">
                                ...
                                <p>
                                    <span className="font-medium">Zwecke und Rechtsgrundlage:</span> Wir beantworten
                                    Ihre Anfrage und
                                    kontaktieren Sie bezüglich eines Angebots für Fenster – Art. 6 Abs. 1 lit.
                                    b oder f DSGVO.
                                </p>
                                <p>
                                    <span className="font-medium">Umfang:</span> Vorname, Nachname, E‑Mail, Telefon,
                                    Postleitzahl sowie Inhalt der
                                    Anfrage.
                                </p>
                                <p>
                                    <span className="font-medium">Freiwilligkeit:</span> Die Angabe der Daten ist
                                    freiwillig, jedoch für die
                                    Kontaktaufnahme erforderlich.
                                </p>
                                <p>
                                    <span className="font-medium">Empfänger:</span> Hosting‑/IT‑Dienstleister und
                                    E‑Mail‑Anbieter – ausschließlich
                                    als Auftragsverarbeiter in unserem Auftrag.
                                </p>
                                <p>
                                    <span className="font-medium">Speicherdauer:</span> bis zu [12] Monate nach
                                    Abschluss der Kommunikation oder
                                    länger zum Schutz von Rechtsansprüchen; bei Einwilligung – bis zu deren
                                    Widerruf.
                                </p>
                                <p>
                                    <span className="font-medium">Rechte:</span> Auskunft, Berichtigung, Löschung,
                                    Einschränkung, Widerspruch,
                                    Datenübertragbarkeit, Beschwerde bei der Aufsichtsbehörde (UODO).
                                </p>
                                <p>
                                    <span className="font-medium">Automatisierte Entscheidungen/Profiling:</span> nicht
                                    vorhanden.
                                </p>
                            </div>
                        </section>
                        ...
                        <p className="text-sm text-gray-500">
                            <span className="font-medium">Hinweis:</span> Dieses Dokument ist eine Vorlage und muss ggf.
                            an die
