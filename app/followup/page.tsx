...
export default function Followup() {
    return (
        <div
            ...
            <main
                className="mm flex flex-col gap-6 sm:gap-10 row-start-2 items-center w-full relative p-4 sm:p-8 md:p-10 min-h-[95vh] sm:min-h-0">
                <div className={'flex flex-col items-center gap-4 text-center'}>
                    <h1 className={'text-[26px] sm:text-[38px] font-bold'}>2-Minuten-Fensterberatung</h1>
                    <h2 className={'text-[14px] sm:text-[21px] font-normal text-slate-700'}>Erfahren Sie, wie viel Sie
                        sparen können – und sichern Sie sich ein unverbindliches Angebot.</h2>
                </div>
                <h2 className={' text-[15px] text-accent font-medium max-w-[600px] text-center'}>
